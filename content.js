...
const fetchUsername = () => currentUsername = currentUsername ?? ([...document.querySelectorAll('div[data-testid="SideNav_AccountSwitcher_Button"] span')].pop() ?? {textContent: null}).textContent;
